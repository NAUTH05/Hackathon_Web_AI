...
function AuthProvider({ children }) {
    ...
    async function register(data) {
        try {
            const { token, user: userData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].register(data);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setToken"])(token);
            const u = userData;
            setUser(u);
            return {
    ...
    const roleLevel = user?.roleLevel ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROLE_LEVELS"].EMPLOYEE;
    const isAdmin = user?.role === "admin" || roleLevel === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROLE_LEVELS"].ADMIN;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5098aba1._.js.map